...
myCursor.execute("create database if not exists iNeuronTasksClass")
myCursor.execute("use iNeuronTasksClass")
myCursor.execute("create table if not exists attribute(Dress_ID int(50), Style varchar(30),	Price varchar(20), Rating int(20), Size varchar(10), Season varchar(30), NeckLine varchar(30), SleeveLength varchar(30), waiseline varchar(30), Material varchar(30),FabricType	varchar(30), Decoration varchar(30),Pattern_Type varchar(30), Recommendation int(2)) ")
